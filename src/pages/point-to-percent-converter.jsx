...
export default function HMAC() {
  ...
  return (
    <div>
      <Head>
        <title>Point to Percentage Converter Online | DevFinds</title>
        <meta
          name="description"
          content="Quickly convert your Point values to Percentage with this tool"
        />
      </Head>
      <Header />
      <div className="max-w-8xl relative mx-auto flex justify-center sm:px-2 lg:px-8 xl:px-12">
        ...
        <div className="min-w-0 max-w-2xl flex-auto px-4 py-4 lg:max-w-none lg:pr-0 lg:pl-8">
          <StyleConverter type={'point-percent'} />
        </div>
      </div>
      <Footer />
    </div>
