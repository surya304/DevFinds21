...
export default function HMAC() {
  ...
  return (
    <div>
      <Head>
        <title>Percentage to Pixel Converter Online | DevFinds</title>
        <meta
          name="description"
          content="Quickly convert your Percentage values to Pixels with this tool"
        />
      </Head>
      <Header />
      <div className="max-w-8xl relative mx-auto flex justify-center sm:px-2 lg:px-8 xl:px-12">
        ...
        <div className="min-w-0 max-w-2xl flex-auto px-4 py-4 lg:max-w-none lg:pr-0 lg:pl-8">
          <StyleConverter type={'percent-px'} />
        </div>
      </div>
      <Footer />
    </div>
